...
equal to val. The remaining elements of nums are not important as well as the size of nums. Return
k.
...
0, 1, 3, and 4. Note that the five elements can be returned in any order. It does not matter what
...
int main() {
    ...
    int val1 = 3;
    res = sol.removeElement(nums1, val1);
    printArray(nums1);

    vector<int> nums2 = {0, 1, 2, 2, 3, 0, 4, 2};
    int val2 = 2;
    res = sol.removeElement(nums2, val2);
    printArray(nums2);
